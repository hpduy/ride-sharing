 ...
 * @author root
 */
public class EndTripAPI {

    @Test
    public void testEndTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/EndTripAPI";
        EndTripRequest data = TestAPIUtils.CreateEndTripRequest();
