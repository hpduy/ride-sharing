 ...
 * @author root
 */
public class GetComingSoonTripAPI {

    @Test
    public void testGetComingSoonTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/GetComingSoonTripAPI";
        GetInformationUsingUserIdRequest data = TestAPIUtils.CreateGetInformationUsingUserIdRequest();
