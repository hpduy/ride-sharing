 ...
 * @author root
 */
public class AutoParingWhenSearchAPI {

    @Test
    public void testAutoParingWhenSearchAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/AutoParingWhenSearchAPI";
        AutoSearchParingRequest data = TestAPIUtils.CreateAutoSearchParingRequest();
