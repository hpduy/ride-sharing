 ...
 * @author root
 */
public class CreateSocialTripAPI {

    @Test
    public void testCreateSocialTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/CreateSocialTripAPI";
        CreateSocialTripRequest data = TestAPIUtils.CreateCreateSocialTripRequest();
