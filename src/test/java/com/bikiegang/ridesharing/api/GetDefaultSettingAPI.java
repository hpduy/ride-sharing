 ...
 * @author root
 */
public class GetDefaultSettingAPI {

    @Test
    public void testGetDefaultSettingAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/GetDefaultSettingAPI";
        String post = ApiUtils.getInstance().getPost(url,"");
