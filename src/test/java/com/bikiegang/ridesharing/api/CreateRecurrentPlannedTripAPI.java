 ...
 * @author root
 */
public class CreateRecurrentPlannedTripAPI {

    @Test
    public void testCreateRecurrentPlannedTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/CreateRecurrentPlannedTripAPI";
