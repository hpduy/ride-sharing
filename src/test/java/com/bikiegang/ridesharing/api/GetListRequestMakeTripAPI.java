 ...
 * @author root
 */
public class GetListRequestMakeTripAPI {

    @Test
    public void testGetListRequestMakeTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/GetListRequestMakeTripAPI";
