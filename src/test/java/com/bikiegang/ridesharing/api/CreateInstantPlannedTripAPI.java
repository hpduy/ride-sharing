 ...
 * @author root
 */
public class CreateInstantPlannedTripAPI {

    @Test
    public void testCreateInstantPlannedTripAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/CreatePlannedTripRequest";
        CreatePlannedTripRequest data = TestAPIUtils.CreateCreatePlannedTripRequest();
        data.getPlannedTrip().setCreatorId("A9yYTzgZnVTUrsbIgKe3PM9nl891lj");
        data.getPlannedTrip().setRole(1);
