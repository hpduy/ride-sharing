 ...
 * @author root
 */
public class GetListRequestMakeTripOfMeAPI {

    @Test
    public void testGetListRequestMakeTripOfMeAPI() {
        String url = "http://103.20.148.111:8080/RideSharing/GetListRequestMakeTripOfMeAPI";
        GetListRequestMakeTripRequest data = TestAPIUtils.CreateGetListRequestMakeTripRequest();
