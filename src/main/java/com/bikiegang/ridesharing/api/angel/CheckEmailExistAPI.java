...
public class CheckEmailExistAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AngelLoginRequest checkEmailRequest = (AngelLoginRequest) Parser.JSonToObject(jsonData.toString(), AngelLoginRequest.class);
            AngelController controller = new AngelController();
            String result = controller.checkEmailExist(checkEmailRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
