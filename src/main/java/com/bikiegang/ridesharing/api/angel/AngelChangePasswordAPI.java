...
import com.bikiegang.ridesharing.pojo.request.angel.AngelChangePasswordRequest;
...
public class AngelChangePasswordAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = AngelChangePasswordRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AngelChangePasswordRequest changePasswordRequest = (AngelChangePasswordRequest) Parser.JSonToObject(jsonData.toString(), AngelChangePasswordRequest.class);
            AngelController controller = new AngelController();
            String result = controller.changePassword(changePasswordRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
