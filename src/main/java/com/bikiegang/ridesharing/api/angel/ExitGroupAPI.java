...
public class ExitGroupAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = ExitGroupRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ExitGroupRequest exitGroupRequest = (ExitGroupRequest) Parser.JSonToObject(jsonData.toString(), ExitGroupRequest.class);
            AngelGroupMemberController controller = new AngelGroupMemberController();
            String result = controller.exitGroup(exitGroupRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
