...
public class JoinGroupAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = JoinGroupRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JoinGroupRequest joinGroupRequest = (JoinGroupRequest) Parser.JSonToObject(jsonData.toString(), JoinGroupRequest.class);
            AngelGroupMemberController controller = new AngelGroupMemberController();
            String result = controller.joinGroup(joinGroupRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
