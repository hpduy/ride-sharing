...
public class SendFeedbackAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = Feedback.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Feedback feedback = (Feedback) Parser.JSonToObject(jsonData.toString(), Feedback.class);
            FeedbackController controller = new FeedbackController();
            String result = controller.sendFeedback(feedback);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
