...
import com.bikiegang.ridesharing.controller.SocialTripController;
...
public class CreateSocialTripAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = CreateSocialTripRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CreateSocialTripRequest createSocialTripRequest = (CreateSocialTripRequest) Parser.JSonToObject(jsonData.toString(), CreateSocialTripRequest.class);
            SocialTripController controller = new SocialTripController();
            String result = controller.createSocialTrip(createSocialTripRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
