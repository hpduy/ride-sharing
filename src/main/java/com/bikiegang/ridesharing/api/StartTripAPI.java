...
import com.bikiegang.ridesharing.controller.TripController;
...
public class StartTripAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = StartTripRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            StartTripRequest startTripRequest = (StartTripRequest) Parser.JSonToObject(jsonData.toString(), StartTripRequest.class);
            TripController controller = new TripController();
            String result = controller.startTrip(startTripRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
