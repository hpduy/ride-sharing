...
public class UpdateReadConversationAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UpdateReadConversationRequest updateReadConversationRequest = (UpdateReadConversationRequest) Parser.JSonToObject(jsonData.toString(), UpdateReadConversationRequest.class);
            ConversationController controller = new ConversationController();
            String result = controller.updateReadConversation(updateReadConversationRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
