...
public class UpdateProfileAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UpdateProfileRequest updateProfileRequest
                    = (UpdateProfileRequest) Parser.JSonToObject(jsonData.toString(),UpdateProfileRequest.class);
            UserController controller = new UserController();
            out.print(controller.updateProfile(updateProfileRequest));
        }catch (Exception ex){
