...
public class AddPopularLocationAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = AddPopularLocationRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AddPopularLocationRequest addPopularLocationRequest = (AddPopularLocationRequest) Parser.JSonToObject(jsonData.toString(), AddPopularLocationRequest.class);
            PopularLocationController controller = new PopularLocationController();
            String result = controller.addPopularLocation(addPopularLocationRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
