...
import com.bikiegang.ridesharing.pojo.response.CreateRecurrentPlannedTripResponse;
...
public class CreateRecurrentPlannedTripAPI extends HttpServlet {

    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = CreatePlannedTripRequest.class;
    public Class responseClass = CreateRecurrentPlannedTripResponse.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String result = controller.createRecurrentPlannedTrip(createPlannedTripRequest);
            logger.info(result);
            out.print(result);
