...
import com.bikiegang.ridesharing.pojo.request.InterestedInRequest;
...
public class InterestedInAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = InterestedInRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            InterestedInRequest interestedInRequest = (InterestedInRequest) Parser.JSonToObject(jsonData.toString(), InterestedInRequest.class);
            UserController controller = new UserController();
            String result = controller.interestIn(interestedInRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
