...
import com.bikiegang.ridesharing.controller.TripCalendarController;
...
public class GetListTripByCalendarAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = GetTripByCalendarRequest.class;
    public Class responseClass = GetTripByCalendarResponse.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GetTripByCalendarRequest getTripByCalendarRequest = (GetTripByCalendarRequest) Parser.JSonToObject(jsonData.toString(), GetTripByCalendarRequest.class);
            TripCalendarController controller = new TripCalendarController();
            String result = controller.getListTripInCalendar(getTripByCalendarRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
