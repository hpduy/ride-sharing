...
public class GetMessageHistoryAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = GetMessagesHistoryRequest.class;
    public Class responseClass = MessagesCommon.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GetMessagesHistoryRequest getMessagesHistoryRequest = (GetMessagesHistoryRequest) Parser.JSonToObject(jsonData.toString(), GetMessagesHistoryRequest.class);
            MessageController controller = new MessageController();
            String result = controller.getMessagesHistory(getMessagesHistoryRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
