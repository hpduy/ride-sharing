...
public class SaveMessagesAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = MessagesCommon.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MessagesCommon messagesCommon = (MessagesCommon) Parser.JSonToObject(jsonData.toString(), MessagesCommon.class);
            MessageController controller = new MessageController();
            String result = controller.saveMessage(messagesCommon);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
