...
import com.bikiegang.ridesharing.controller.OrganizationController;
...
public class GetOrganizationsAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = null;
    public Class responseClass = GetOrganizationsResponse.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String result = controller.getListOfOrganization();
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
