...
public class RemovePlannedTripAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GetPlannedTripDetailRequest removePlannedTripRequest = (GetPlannedTripDetailRequest) Parser.JSonToObject(jsonData.toString(), GetPlannedTripDetailRequest.class);
            PlannedTripController controller = new PlannedTripController();
            String result = controller.removePlannedTrip(removePlannedTripRequest);
            logger.info(result);
            out.print(result);
