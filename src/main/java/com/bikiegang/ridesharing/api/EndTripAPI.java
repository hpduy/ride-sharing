...
public class EndTripAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = EndTripRequest.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EndTripRequest endTripRequest = (EndTripRequest) Parser.JSonToObject(jsonData.toString(), EndTripRequest.class);
            TripController controller = new TripController();
            String result = controller.endTrip(endTripRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
