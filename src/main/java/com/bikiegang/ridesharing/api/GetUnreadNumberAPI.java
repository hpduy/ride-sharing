...
public class GetUnreadNumberAPI extends HttpServlet {
    private Logger logger = LogUtil.getLogger(this.getClass());
    public Class requestClass = GetInformationUsingUserIdRequest.class;
    public Class responseClass = GetUnreadNumberResponse.class;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String result = controller.getUnreadNumber(getInformationUsingUserIdRequest);
            logger.info(result);
            out.print(result);
        } catch (Exception ex) {
            ex.printStackTrace();
