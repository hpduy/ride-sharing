 ...
 public class ConvertUtils
 {
   ...
   public static float toFloat(Object value, float def) {
     ...
     try
     {
       return Float.valueOf(value.toString()).floatValue(); } catch (Exception e) {
     }
     return def;
   }
   ...
   public static double toDouble(Object value, double def) {
     ...
     try
     {
       return Double.valueOf(value.toString()).doubleValue(); } catch (Exception e) {
     }
     return def;
   }
   ...
   public static int toInt(Object value, int def) {
     ...
     try
     {
       return Integer.valueOf(value.toString()).intValue(); } catch (Exception e) {
     }
     return def;
   }
   ...
   public static long toLong(Object value, long def) {
     ...
     try
     {
       return Long.valueOf(value.toString()).longValue(); } catch (Exception e) {
     }
     return def;
   }
   ...
   public static String toString(Object obj, String defaultValue) {
     try {
       ...
       return obj.toString(); } catch (Exception e) {
     }
     return defaultValue;
   }
   ...
   public static long bytesToLong(byte[] bytes, long defaultValue) {
     try {
       ...
       buffer.put(bytes);
       buffer.flip();
       return buffer.getLong(); } catch (Exception ex) {
     }
     return defaultValue;
   }
 }
...
/* 
 * Qualified Name:     com.annn.framework.util.ConvertUtils
 * 
 */