...
public class FeedbackDao {
    ...
    public boolean insert(Feedback obj) {
        ...
        try {
            ...
            //put hashmap
            database.getFeedbackHashMap().put(obj.getId(), obj);
            //Step 2: put redis
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Insert Feedback success with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
    ...
    public boolean delete(Feedback obj) {
        ...
        try {
            ...
            //remove in hashmap
            database.getFeedbackHashMap().remove(obj.getId());
            //Step 2: remove redis
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Delete Feedback success with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
        ...
        try {
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Update Feedback with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
