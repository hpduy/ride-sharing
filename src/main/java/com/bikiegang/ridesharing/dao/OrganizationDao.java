...
public class OrganizationDao {
    ...
    public boolean insert(Organization obj) {
        ...
        try {
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Insert Organization success with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
    ...
    public boolean delete(Organization obj) {
        boolean result = false;
        try {
            if (obj == null) {
                return false;
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Delete Organization success with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
    ...
    public boolean update(Organization obj) {
        boolean result = false;
        try {
            if (obj == null) {
                return false;
            ...
            if (result) {
                ...
                if (!result) {
                    ...
                    logger.info(String.format("Update Organization with value=%s", JSONUtil.Serialize(obj)));
                }
            } else {
