...
public class EventDao {
    ...
    public boolean insert(Event obj) {
        ...
        try {
            ...
            //put hashmap
            database.getEventHashMap().put(obj.getEventId(), obj);
            //Step 2: put redis
            result = cache.hset(obj.getClass().getName(), String.valueOf(obj.getEventId()), JSONUtil.Serialize(obj));
            if (result) {
                ...
                logger.error(String.format("Can't not insert redis with key=%s, field=%s, value=%s",
                        obj.getClass().getName(), String.valueOf(obj.getEventId()), JSONUtil.Serialize(obj)));
            }
        } catch (Exception ex) {
    ...
    public boolean delete(Event obj) {
        ...
        try {
            ...
            //remove in hashmap
            database.getEventHashMap().remove(obj.getEventId());
            //Step 2: remove redis
            result = cache.hdel(obj.getClass().getName(), String.valueOf(obj.getEventId()));
