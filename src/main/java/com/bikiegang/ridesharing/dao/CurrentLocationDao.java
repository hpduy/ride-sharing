...
public class CurrentLocationDao {
    ...
    public boolean insert(CurrentLocation obj) {
        ...
        try {
            ...
            database.getCurrentLocationHashMap().put(obj.getId(), obj);
            //Step 2: put redis
    ...
    public boolean delete(CurrentLocation obj) {
        boolean result = false;
        try {
            if (obj == null) {
                return false;
            ...
            //Step 1: put in hashmap
            database.getCurrentLocationHashMap().remove(obj.getId());
            //Step 2: put redis
            if (result) {
                //Step 3: put job gearman
    ...
    public boolean update(CurrentLocation obj) {
        boolean result = false;
        try {
            if (obj == null) {
                return false;
